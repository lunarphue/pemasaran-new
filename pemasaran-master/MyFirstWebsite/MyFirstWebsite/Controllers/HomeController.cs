...
namespace MyFirstWebsite.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            //ViewBag.Pengecers = new SelectList(mdb.Pengecers,"Kode_Pengecer","Name");
        ...
        public ActionResult Index(Lists list)
        {
            if (ModelState.IsValid)
            {
                ...
                using (var db = new MainDbContext())
                {
                    ...
                    var userIdQuery = db.Users.Where(u => u.Email == userEmail).Select(u => u.User_Id);
        ...
        //[HttpGet]
        //public ActionResult UpdateStok()
        //{
        //    var db = new MainDbContext();
        //    ViewBag.Assigns = new SelectList(db.Assigns, "Id_ass", "Kode_Pengecer");
        //    return View(db.StokPengecers.ToList());
        //}
    }
}